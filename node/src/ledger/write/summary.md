...
- **Reconstruction**: Rebuilds staged ledgers from scan state and pending coinbases
...
- **Service Layer**: Routes operations through LedgerManager for actual ledger manipulation
