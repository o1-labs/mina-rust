...
Manages concurrent read operations on ledgers with cost-based throttling to prevent service overload.
...
## Interactions
- **RPC Integration**: Serves account queries, ledger status, and scan state summaries
- **P2P Integration**: Responds to ledger sync queries and staged ledger part requests
- **VRF Integration**: Constructs delegator tables for block production
- **Service Integration**: Routes requests through LedgerManager with cost tracking
