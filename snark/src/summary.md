...
Orchestrates proof verification workflows for the Mina protocol. This crate contains state machine logic only - actual cryptographic verification is performed by the ledger crate.
...
- **User Command Verify**: Manages transaction and zkApp proof verification workflows
