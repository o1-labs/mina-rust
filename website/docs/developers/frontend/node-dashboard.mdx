...
- **`leaderboard`** - Leaderboard configuration for community participation
  tracking. Optimized for testnet participation metrics and rankings.
...
```bash
# Start Node Dashboard with webnode environment
docker-compose -f docker-compose.frontend.yml up frontend-webnode

# Start Node Dashboard with producer environment
docker-compose -f docker-compose.frontend.yml up frontend-producer
```
